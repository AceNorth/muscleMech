...
export const Player = {
  ...
  // this faction's base's Military Points Per Day increase by their growthRate 
	// startingGrowthRate: 0,
 //  startingMilitaryPoints: 1000,
 //  startingMilitaryPointsPerDay: 100,
